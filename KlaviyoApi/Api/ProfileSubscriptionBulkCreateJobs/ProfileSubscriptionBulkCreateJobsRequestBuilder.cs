...
using System;
namespace Klaviyo.Api.ProfileSubscriptionBulkCreateJobs
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Klaviyo.Api.ProfileSubscriptionBulkCreateJobs.ProfileSubscriptionBulkCreateJobsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <exception cref="global::Klaviyo.Models.ProfileSubscriptionBulkCreateJobs4XXError">When receiving a 4XX status code</exception>
        /// <exception cref="global::Klaviyo.Models.ProfileSubscriptionBulkCreateJobs5XXError">When receiving a 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task PostAsync(global::Klaviyo.Models.SubscriptionCreateJobCreateQuery body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(global::Klaviyo.Models.SubscriptionCreateJobCreateQuery body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "4XX", global::Klaviyo.Models.ProfileSubscriptionBulkCreateJobs4XXError.CreateFromDiscriminatorValue },
                { "5XX", global::Klaviyo.Models.ProfileSubscriptionBulkCreateJobs5XXError.CreateFromDiscriminatorValue },
            };
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Klaviyo.Models.SubscriptionCreateJobCreateQuery body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Klaviyo.Models.SubscriptionCreateJobCreateQuery body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Klaviyo.Api.ProfileSubscriptionBulkCreateJobs.ProfileSubscriptionBulkCreateJobsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Klaviyo.Api.ProfileSubscriptionBulkCreateJobs.ProfileSubscriptionBulkCreateJobsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Klaviyo.Api.ProfileSubscriptionBulkCreateJobs.ProfileSubscriptionBulkCreateJobsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
