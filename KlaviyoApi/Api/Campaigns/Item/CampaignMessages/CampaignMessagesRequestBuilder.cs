...
namespace Klaviyo.Api.Campaigns.Item.CampaignMessages
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Klaviyo.Api.Campaigns.Item.CampaignMessages.CampaignMessagesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <exception cref="global::Klaviyo.Models.GetCampaignMessageResponseCollectionCompoundDocument4XXError">When receiving a 4XX status code</exception>
        /// <exception cref="global::Klaviyo.Models.GetCampaignMessageResponseCollectionCompoundDocument5XXError">When receiving a 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Klaviyo.Models.GetCampaignMessageResponseCollectionCompoundDocument?> GetAsync(Action<RequestConfiguration<global::Klaviyo.Api.Campaigns.Item.CampaignMessages.CampaignMessagesRequestBuilder.CampaignMessagesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Klaviyo.Models.GetCampaignMessageResponseCollectionCompoundDocument> GetAsync(Action<RequestConfiguration<global::Klaviyo.Api.Campaigns.Item.CampaignMessages.CampaignMessagesRequestBuilder.CampaignMessagesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "4XX", global::Klaviyo.Models.GetCampaignMessageResponseCollectionCompoundDocument4XXError.CreateFromDiscriminatorValue },
                { "5XX", global::Klaviyo.Models.GetCampaignMessageResponseCollectionCompoundDocument5XXError.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Klaviyo.Models.GetCampaignMessageResponseCollectionCompoundDocument>(requestInfo, global::Klaviyo.Models.GetCampaignMessageResponseCollectionCompoundDocument.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Return all messages that belong to the given campaign.&lt;br&gt;&lt;br&gt;*Rate limits*:&lt;br&gt;Burst: `10/s`&lt;br&gt;Steady: `150/m`**Scopes:**`campaigns:read`
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Klaviyo.Api.Campaigns.Item.CampaignMessages.CampaignMessagesRequestBuilder.CampaignMessagesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Klaviyo.Api.Campaigns.Item.CampaignMessages.CampaignMessagesRequestBuilder.CampaignMessagesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Klaviyo.Api.Campaigns.Item.CampaignMessages.CampaignMessagesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Klaviyo.Api.Campaigns.Item.CampaignMessages.CampaignMessagesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Klaviyo.Api.Campaigns.Item.CampaignMessages.CampaignMessagesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Return all messages that belong to the given campaign.&lt;br&gt;&lt;br&gt;*Rate limits*:&lt;br&gt;Burst: `10/s`&lt;br&gt;Steady: `150/m`**Scopes:**`campaigns:read`
        /// </summary>
...
#nullable enable
            [QueryParameter("include")]
            public global::Klaviyo.Api.Campaigns.Item.CampaignMessages.GetIncludeQueryParameterType[]? IncludeAsGetIncludeQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("include")]
            public global::Klaviyo.Api.Campaigns.Item.CampaignMessages.GetIncludeQueryParameterType[] IncludeAsGetIncludeQueryParameterType { get; set; }
