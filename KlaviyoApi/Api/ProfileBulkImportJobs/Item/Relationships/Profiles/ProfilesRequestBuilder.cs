...
using System;
namespace Klaviyo.Api.ProfileBulkImportJobs.Item.Relationships.Profiles
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Klaviyo.Api.ProfileBulkImportJobs.Item.Relationships.Profiles.ProfilesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Klaviyo.Api.ProfileBulkImportJobs.Item.Relationships.Profiles.ProfilesRequestBuilder.ProfilesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Klaviyo.Api.ProfileBulkImportJobs.Item.Relationships.Profiles.ProfilesRequestBuilder.ProfilesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Klaviyo.Api.ProfileBulkImportJobs.Item.Relationships.Profiles.ProfilesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Klaviyo.Api.ProfileBulkImportJobs.Item.Relationships.Profiles.ProfilesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Klaviyo.Api.ProfileBulkImportJobs.Item.Relationships.Profiles.ProfilesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get profile relationships for the bulk profile import job with the given ID.&lt;br&gt;&lt;br&gt;*Rate limits*:&lt;br&gt;Burst: `10/s`&lt;br&gt;Steady: `150/m`**Scopes:**`profiles:read`
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ProfilesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Klaviyo.Api.ProfileBulkImportJobs.Item.Relationships.Profiles.ProfilesRequestBuilder.ProfilesRequestBuilderGetQueryParameters>
        {
        }
    }
}
