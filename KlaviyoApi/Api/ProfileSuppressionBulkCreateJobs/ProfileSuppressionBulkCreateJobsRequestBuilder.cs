...
namespace Klaviyo.Api.ProfileSuppressionBulkCreateJobs
{
    ...
    public partial class ProfileSuppressionBulkCreateJobsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::Klaviyo.Models.ProfileSuppressionBulkCreateJobs4XXError">When receiving a 4XX status code</exception>
        /// <exception cref="global::Klaviyo.Models.ProfileSuppressionBulkCreateJobs5XXError">When receiving a 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task PostAsync(global::Klaviyo.Models.SuppressionCreateJobCreateQuery body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(global::Klaviyo.Models.SuppressionCreateJobCreateQuery body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "4XX", global::Klaviyo.Models.ProfileSuppressionBulkCreateJobs4XXError.CreateFromDiscriminatorValue },
                { "5XX", global::Klaviyo.Models.ProfileSuppressionBulkCreateJobs5XXError.CreateFromDiscriminatorValue },
            };
