...
using System;
namespace Klaviyo.Api.CatalogCategories.Item.Items
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Klaviyo.Api.CatalogCategories.Item.Items.ItemsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Klaviyo.Api.CatalogCategories.Item.Items.ItemsRequestBuilder.ItemsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Klaviyo.Api.CatalogCategories.Item.Items.ItemsRequestBuilder.ItemsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Klaviyo.Api.CatalogCategories.Item.Items.ItemsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Klaviyo.Api.CatalogCategories.Item.Items.ItemsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Klaviyo.Api.CatalogCategories.Item.Items.ItemsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get all items in a category with the given category ID.Items can be sorted by the following fields, in ascending and descending order:`created`Returns a maximum of 100 items per request.&lt;br&gt;&lt;br&gt;*Rate limits*:&lt;br&gt;Burst: `350/s`&lt;br&gt;Steady: `3500/m`**Scopes:**`catalogs:read`
        /// </summary>
...
#nullable enable
            [QueryParameter("fields%5Bcatalog%2Ditem%5D")]
            public global::Klaviyo.Api.CatalogCategories.Item.Items.GetFieldsCatalogItemQueryParameterType[]? FieldscatalogItemAsGetFieldsCatalogItemQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("fields%5Bcatalog%2Ditem%5D")]
            public global::Klaviyo.Api.CatalogCategories.Item.Items.GetFieldsCatalogItemQueryParameterType[] FieldscatalogItemAsGetFieldsCatalogItemQueryParameterType { get; set; }
...
#nullable enable
            [QueryParameter("fields%5Bcatalog%2Dvariant%5D")]
            public global::Klaviyo.Api.CatalogCategories.Item.Items.GetFieldsCatalogVariantQueryParameterType[]? FieldscatalogVariantAsGetFieldsCatalogVariantQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("fields%5Bcatalog%2Dvariant%5D")]
            public global::Klaviyo.Api.CatalogCategories.Item.Items.GetFieldsCatalogVariantQueryParameterType[] FieldscatalogVariantAsGetFieldsCatalogVariantQueryParameterType { get; set; }
...
#nullable enable
            [QueryParameter("include")]
            public global::Klaviyo.Api.CatalogCategories.Item.Items.GetIncludeQueryParameterType[]? IncludeAsGetIncludeQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("include")]
            public global::Klaviyo.Api.CatalogCategories.Item.Items.GetIncludeQueryParameterType[] IncludeAsGetIncludeQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>For more information please visit https://developers.klaviyo.com/en/v2024-07-15/reference/api-overview#sorting</summary>
            [QueryParameter("sort")]
            public global::Klaviyo.Api.CatalogCategories.Item.Items.GetSortQueryParameterType? SortAsGetSortQueryParameterType { get; set; }
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.18.0")]
        public partial class ItemsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Klaviyo.Api.CatalogCategories.Item.Items.ItemsRequestBuilder.ItemsRequestBuilderGetQueryParameters>
        {
        }
    }
}
