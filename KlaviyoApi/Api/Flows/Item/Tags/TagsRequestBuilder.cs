...
using System;
namespace ApiSdk.Api.Flows.Item.Tags
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Api.Flows.Item.Tags.TagsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::ApiSdk.Models.GetTagResponseCollection?> GetAsync(Action<RequestConfiguration<global::ApiSdk.Api.Flows.Item.Tags.TagsRequestBuilder.TagsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ApiSdk.Models.GetTagResponseCollection> GetAsync(Action<RequestConfiguration<global::ApiSdk.Api.Flows.Item.Tags.TagsRequestBuilder.TagsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Api.Flows.Item.Tags.TagsRequestBuilder.TagsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Api.Flows.Item.Tags.TagsRequestBuilder.TagsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Api.Flows.Item.Tags.TagsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ApiSdk.Api.Flows.Item.Tags.TagsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ApiSdk.Api.Flows.Item.Tags.TagsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Return all tags associated with the given flow ID.&lt;br&gt;&lt;br&gt;*Rate limits*:&lt;br&gt;Burst: `3/s`&lt;br&gt;Steady: `60/m`**Scopes:**`flows:read``tags:read`
        /// </summary>
...
#nullable enable
            [QueryParameter("fields%5Btag%5D")]
            public global::ApiSdk.Api.Flows.Item.Tags.GetFieldsTagQueryParameterType[]? FieldstagAsGetFieldsTagQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("fields%5Btag%5D")]
            public global::ApiSdk.Api.Flows.Item.Tags.GetFieldsTagQueryParameterType[] FieldstagAsGetFieldsTagQueryParameterType { get; set; }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.18.0")]
        public partial class TagsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::ApiSdk.Api.Flows.Item.Tags.TagsRequestBuilder.TagsRequestBuilderGetQueryParameters>
        {
        }
    }
}
