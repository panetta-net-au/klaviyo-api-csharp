...
namespace ApiSdk.Models
{
    ...
    public partial class StaticScheduleOptions : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// <summary>If the campaign should be sent with local recipient timezone send (requires UTC time) or statically sent at the given time. Defaults to False.</summary>
